...
class ViewController: UIViewController, AGSMapViewLayerDelegate, UISearchBarDelegate, AGSLocatorDelegate, AGSCalloutDelegate, AGSRouteTaskDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "http://services.arcgisonline.com/ArcGIS/rest/services/ESRI_StreetMap_World_2D/MapServer")
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        if self.graphicLayer == nil {
            ...
            let pushpin = AGSPictureMarkerSymbol(imageNamed: "google-maps-pin-hi.png")
        ...
        params.location = AGSPoint(x:10, y:49, spatialReference: AGSSpatialReference(WKID: 4326))
